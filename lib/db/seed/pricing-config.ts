...
const basePlans: PricingPlanConfig[] = [
  ...
  /* ---------------------------- PRO MONTHLY ---------------------------- */
  {
    ...
    provider: 'stripe',
    stripePriceId: 'price_1UCJNvD4Hgl3nYTAbZv8PPtF',
    stripeProductId: 'prod_VCip2OifW2YCb1',
  ...
  /* ---------------------------- MAX MONTHLY ---------------------------- */
  {
    ...
    provider: 'stripe',
    stripePriceId: 'price_1UCJNxD4Hgl3nYTAinnrqYk1',
    stripeProductId: 'prod_VCipScDxYbZTlJ',
    paymentType: 'recurring',
    recurringInterval: 'month',
    price: '29',
    currency: 'USD',
  ...
  /* ----------------------------- PRO ANNUAL ---------------------------- */
  {
    ...
    provider: 'stripe',
    stripePriceId: 'price_1UCJNwD4Hgl3nYTAmsSz9ZsE',
    stripeProductId: 'prod_VCip2OifW2YCb1',
    paymentType: 'recurring',
  ...
  /* ----------------------------- MAX ANNUAL ---------------------------- */
  {
    ...
    provider: 'stripe',
    stripePriceId: 'price_1UCJNyD4Hgl3nYTA5JmV82Wz',
    stripeProductId: 'prod_VCipScDxYbZTlJ',
    paymentType: 'recurring',
    recurringInterval: 'year',
    price: '290',
  ...
  /* --------------------------- CREDIT TOP-UP --------------------------- */
  {
    ...
    provider: 'stripe',
    stripePriceId: 'price_1UCJO0D4Hgl3nYTANyqBhnPr',
    stripeProductId: 'prod_VCip4cj9jvnTcY',
